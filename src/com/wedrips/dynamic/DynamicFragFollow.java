...
public class DynamicFragFollow extends Fragment {
	...
	public void initEntity(List<DynamicValueEntity> viewEntity) {
		...
		viewEntity.add(new DynamicValueEntity( R.drawable.wedrips,"微滴", "5:20", "丰富线下生活！", R.color.yellow,0,0,0,null,0));
		...
		viewEntity.add(new DynamicValueEntity( R.drawable.wedrips,"微滴", "5:20", "以奋斗者为本！", R.color.red_french,0,0,0,null,0));
