...
public class PhotoAnimationView extends ImageView {
    ...
    public PhotoAnimationView(Context context) {
        super(context);
        init();
    }

    public PhotoAnimationView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public PhotoAnimationView(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            mScaleCenter.set(detector.getFocusX(), detector.getFocusY());
    ...
    private Runnable mClickRunnable = new Runnable() {
        ...
        public void run() {
            if (mClickListener != null) {
                mClickListener.onClick(PhotoAnimationView.this);
            }
        }
    };
    ...
    private GestureDetector.OnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            if (mLongClick != null) {
                mLongClick.onLongClick(PhotoAnimationView.this);
            }
        }
